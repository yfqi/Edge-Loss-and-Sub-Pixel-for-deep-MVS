...
class MVSDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            mask_filename_hr = os.path.join(self.datapath, 'Depth_raw/{}/depth_visual_{:0>4}.png'.format(scan, vid))
            depth_filename_hr = os.path.join(self.datapath, 'Depth_raw/{}/depth_map_{:0>4}.pfm'.format(scan, vid))
