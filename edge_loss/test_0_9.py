...
parser.add_argument('--outdir', default='/media/public/disk4/yfq/cas_gttdt_dilate/10', help='output dir')
...
def save_scene_depth(testlist):
    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            #             outputs["photometric_confidence"][index[0], index[1] + l, index[2] + r] = 0.901
            #
            #             while len(list1) > 0:
            #                 elem = list1.pop()
