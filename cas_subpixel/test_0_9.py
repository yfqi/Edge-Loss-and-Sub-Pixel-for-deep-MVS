...
parser.add_argument('--outdir', default='/media/public/yan222/yfq/exp/aaa/cas_subpixel/out', help='output dir')
...
#filter by gimupa
parser.add_argument('--fusibile_exe_path', type=str, default='/media/public/yan222/yfq/fusibile-master/fusibile')
